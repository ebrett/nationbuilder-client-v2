...
- Delegate business logic appropriately (see @rails-architect for pattern selection: form objects, query objects, model methods, or service objects for coordination problems)
